    ...
    <main>
        <section class="intro-section bg-full-white" style="padding: 4rem 0; text-align: center; position: relative; z-index: 10;">
            <div class="section-container" style="max-width: 900px; margin: 0 auto; padding: 0 1.5rem;">
                <span style="display:inline-block; background: #e0f2fe; color: #0369a1; padding: 6px 16px; border-radius: 50px; font-weight: 700; font-size: 0.85rem; margin-bottom: 1.5rem; letter-spacing: 0.05em;">LAUKAAN MONIPUOLISIN PALVELUALUSTA</span>
